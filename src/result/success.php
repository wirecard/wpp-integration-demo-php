 ...
 * after the transaction is made. Also the payment transaction state must be successful.
 */
$idealMAID = '4aeccf39-0d47-47f6-a399-c05c1f2fc819';
$get_url_iDeal = ELASTIC_ENGINE_CUSTOMER_TEST_BASE_URL . '/engine/rest/merchants/' .
    $idealMAID . '/payments/search?payment.request-id=' . $_SESSION['uuid'];
...
try {
    $response = $client->request('GET', $get_url_iDeal, [
        'headers' => $headers
    ]);
