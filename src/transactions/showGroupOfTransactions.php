...
// get a transaction by passing the arguments transactionId and paymentMethod to getGroupOfTransactions method.
try {
    $response = $service->getGroupOfTransactions($transactionId, $paymentMethod);
