...
// get a transaction by passing the arguments transactionId and paymentMethod to getTransactionByTransactionRequest method.
try {
    // $response = $service->getTransactionByTransactionRequest($transactionId, $paymentMethod); --> has to be implemented
