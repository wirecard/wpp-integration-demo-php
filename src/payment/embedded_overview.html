...
<body>
<div class="container">
    <h1 class="text-center">Wirecard Payment Page Integration Demo - <br> Embedded Credit Card and Alternative Payment
        Methods</h1>
    <div class="panel panel-default" style="margin-top: 1.5em;">
        <div class="panel-heading">
            Choose embedded credit card or one of the currently supported alternative payment methods
        </div>
